  ...
  return (
    <Html center>
      <div className="flex flex-col items-center justify-center">
        <div className="w-16 h-16 border-4 border-t-[#c15f3c] border-[#3f3f3f] rounded-full animate-spin"></div>
  ...
  if (thumbnailUrl && !modelUrl) {
    return (
      <div className="w-full h-full flex flex-col items-center justify-center p-4">
        ...
        <p className="text-[#c15f3c] text-sm mt-2 text-center">
          Click "Apply Textures" in the left sidebar to generate the final 3D
          model
        </p>
        <div className="mt-4 flex items-center">
          <div className="w-3 h-3 bg-[#c15f3c] rounded-full mr-2"></div>
          <p className="text-[#c15f3c] text-xs">Ready for texturing</p>
        </div>
      </div>
    );
  }
