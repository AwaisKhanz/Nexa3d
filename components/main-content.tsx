    ...
    <div className="flex flex-col md:flex-row flex-1 overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-8">
          {isLoading && allTasks.length === 0 ? (
            <div className="flex items-center justify-center h-full">
              <div className="w-8 h-8 border-2 border-t-[#d39fe6] border-[#3f3f3f] rounded-full animate-spin"></div>
            </div>
          ) : (
            <>
              {/* In Progress Section */}
                      ...
                      >
                        <div className="h-32 bg-[#181818] flex items-center justify-center relative">
                          {task.thumbnail_url ? (
                            ...
                            <div className="flex flex-col items-center justify-center">
                              <div className="w-10 h-10 border-2 border-t-[#d39fe6] border-[#3f3f3f] rounded-full animate-spin mb-2"></div>
                        ...
                        <div className="p-3">
                          ...
                          <div className="flex justify-between items-center">
                            ...
                            <span className="text-xs px-2 py-0.5 rounded-full bg-[#d39fe6]/30 text-[#d39fe6]">
                              {task.mode === "preview"
                                ? "Generating"
                                : "Texturing"}{" "}
                              ({task.progress || 0}%)
                        ...
                        <div className="p-3">
                          ...
                          <div className="flex justify-between items-center">
                            ...
                            <button
                              ...
                              className="p-2 bg-[#d39fe6] text-white rounded-md disabled:opacity-50"
                              disabled={
      ...
      <div className="md:hidden fixed bottom-6 right-6 z-50">
        <button
          ...
          className="flex items-center justify-center w-14 h-14 rounded-full bg-[#d39fe6] text-white shadow-lg hover:bg-[#d39fe6] transition-colors"
