    ...
    <header className="flex items-center justify-between px-4 py-3 bg-[#181818] border-b border-[#262626] relative z-40">
      ...
      <div className="flex items-center flex-wrap gap-2">
        ...
        <div className="flex items-center mr-2 md:mr-6">
          ...
          <span className="text-white font-bold text-lg">Mint3D</span>
        </div>
        ...
        <div className="relative group">
          ...
          >
            ...
            <span className="hidden xs:inline">Mint3D</span>
        ...
        <a
          href="#"
          className="hidden md:flex items-center text-white text-sm ml-4 hover:text-[#d39fe6] transition-colors"
          onClick={(e) => {
            e.preventDefault();
            addToast({
              type: "info",
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          className="hidden xs:flex px-3 py-1.5 text-[#d39fe6] text-sm bg-[#262626] !rounded-xl border border-[#3F3F3F] hover:bg-[#3f3f3f] transition-colors"
          onClick={() => {
        ...
        {/* Twitter button */}
        <button
          className="hidden xs:flex px-3 py-1.5 text-white font-medium text-sm !rounded-xl hover:opacity-90 transition-colors bg-[#d39fe6]"
          onClick={() => {
            addToast({
              type: "success",
              title: "Twitter",
        ...
        <div className="absolute top-14 left-0 right-0 bg-[#181818] border-b border-[#262626] z-50 md:hidden">
          <div className="px-4 py-3 space-y-3">
            ...
            <div className="flex flex-col space-y-2">
              <button
                className="w-full px-3 py-1.5 text-[#d39fe6] text-sm bg-[#262626] !rounded-xl hover:bg-[#3f3f3f]"
                onClick={() => {
                  const button = document.activeElement as HTMLButtonElement;
                  const originalText = button.textContent;
                  button.textContent = "Coming soon";
              ...
              <button
                className="w-full px-3 py-1.5 text-white font-medium !rounded-xl text-sm hover:opacity-90 transition-colors bg-[#d39fe6]"
                onClick={() => {
                  addToast({
                    type: "success",
                    title: "Twitter",
