  ...
  return (
    <header className="flex items-center justify-between px-4 py-3 bg-[#181818] border-b border-[#262626] relative z-40">
      ...
      <div className="flex items-center flex-wrap gap-2">
        ...
        <div className="flex items-center mr-2 md:mr-6">
          <div className="w-8 h-8 mr-2 flex items-center justify-center">
            <img
              src="/logo.png"
              alt="Aether Bloom Logo"
              className="w-full h-full object-contain"
            />
          </div>
          <span className="text-white font-bold text-lg">Aether Bloom</span>
        </div>
        ...
        <div className="relative group">
          ...
          >
            ...
            <span className="hidden xs:inline">Aether Bloom</span>
        ...
        <nav className="hidden md:flex space-x-6">
          <a
            href={TWITTER_URL}
            target="_blank"
            className="text-white text-sm hover:text-[#836EF9] transition-colors"
          >
            Twitter
          </a>
          <a
        ...
        <a
          href="#"
          className="hidden md:flex items-center text-white text-sm ml-4 hover:text-[#836EF9] transition-colors"
          onClick={(e) => {
            e.preventDefault();
            addToast({
              type: "info",
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          className="hidden xs:flex px-3 py-1.5 text-[#836EF9] text-sm bg-[#262626] !rounded-xl border border-[#3F3F3F] hover:bg-[#3f3f3f] transition-colors"
          onClick={() => {
        ...
        {/* Twitter button */}
        <button
          className="hidden xs:flex px-3 py-1.5 text-white font-medium text-sm !rounded-xl hover:opacity-90 transition-colors bg-[#836EF9]"
          onClick={() => {
            addToast({
              type: "success",
              title: "Twitter",
        ...
        <div className="absolute top-14 left-0 right-0 bg-[#181818] border-b border-[#262626] z-50 md:hidden">
          <div className="px-4 py-3 space-y-3">
            <nav className="flex flex-col space-y-3">
              <a
                href="https://x.com/AetherBloomAI"
                target="_blank"
                className="text-white text-sm hover:text-[#836EF9] transition-colors"
              >
                Twitter
            ...
            <div className="flex flex-col space-y-2">
              <button
                className="w-full px-3 py-1.5 text-[#836EF9] text-sm bg-[#262626] !rounded-xl hover:bg-[#3f3f3f]"
                onClick={() => {
                  const button = document.activeElement as HTMLButtonElement;
                  const originalText = button.textContent;
                  button.textContent = "Coming soon";
              ...
              <button
                className="w-full px-3 py-1.5 text-white font-medium !rounded-xl text-sm hover:opacity-90 transition-colors bg-[#836EF9]"
                onClick={() => {
                  addToast({
                    type: "success",
                    title: "Twitter",
